...
class DataLoader(Loader):
    ...
    def fetch_ann_features(self, image_id, opt):
        ...
        pool_fc7_feats_dir = osp.join('/home/imi1214/MJP/datasets/feats/', opt['dataset_splitBy'], 'mrcn', ann_feats_dir)        
    ...
    def getBatch(self, split, opt):
        ...
        embedmat_path = '/home/imi1214/MJP/projects/cache/word_embedding/embed_matrix.npy'
        embedding_mat = np.load(embedmat_path)

        vocab_file = '/home/imi1214/MJP/projects/cache/word_embedding/vocabulary_72700.txt'
        f = open(vocab_file, "r")
        ...
        sent_extract = json.load(open(osp.join('/home/imi1214/MJP/projects/cache/sub_obj_wds', dataset + '_' + splitBy, "sent_extract.json")))
