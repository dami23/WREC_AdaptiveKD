...
data_dir = '/home/mi/projects/githubs/KPRN/'
mrcn_dir = osp.join(data_dir, 'pyutils', 'mask-faster-rcnn')
sys.path.insert(0, osp.join(mrcn_dir, 'lib'))
sys.path.insert(0, osp.join(mrcn_dir, 'lib/loaders'))
sys.path.insert(0, osp.join(mrcn_dir, 'data', 'refer'))
sys.path.insert(0, osp.join(mrcn_dir, 'data', 'coco', 'PythonAPI'))

# refer path
refer_dir = osp.join(data_dir, 'pyutils', 'refer')
